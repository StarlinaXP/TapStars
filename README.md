...
Once installation is complete, go to Settings → General → VPN & Device Management.

Tap Trust [Your Apple ID] under the developer profile.

Launch TapStars
You can now play TapStars on your iOS device!

Note: Free Apple developer certificates expire every 7 days. When this happens, simply repeat the signing and installation process to continue playing. (Save data will not be affected)
